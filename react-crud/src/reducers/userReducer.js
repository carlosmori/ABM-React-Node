import { FETCH_USERS, ADD_USER, DELETE_USER, SET_CURRENT_USER, UPDATE_USER } from "../actions/types";
...
export default function(state = initialState, action) {
  switch (action.type) {
    ...
    case UPDATE_USER:
      ...
      const oldUserIndex = usersFromRedux.findIndex( x => x.id === action.payload.id);
